...
<!-- badges: start -->
[![R-CMD-check](https://github.com/insightsengineering/cardinal/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/insightsengineering/cardinal/actions/workflows/R-CMD-check.yaml)
[![Codecov test coverage](https://codecov.io/gh/insightsengineering/cardinal/branch/main/graph/badge.svg)](https://app.codecov.io/gh/insightsengineering/cardinal?branch=main)
<!-- badges: end -->
