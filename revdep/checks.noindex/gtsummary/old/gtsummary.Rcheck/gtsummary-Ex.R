...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed("cardx") && gtsummary:::is_pkg_installed("broom", ref = "cardx")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
trial |>
  tbl_summary(
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed(c("cardx", "survey")) && gtsummary:::is_pkg_installed("broom",  ref = "cardx")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed("cardx")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed(c("cardx", "broom", "car", "parameters"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed("survival")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
library(survival)
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed(c("cardx", "broom", "broom.helpers"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
trial |>
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed(c("survey", "cardx"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
trial |>
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed(c("cardx", "survival", "broom"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
library(survival)
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed("car")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
tbl <-
...
###   add_stat_label.tbl_svysummary add_stat_label.tbl_ard_summary
...
cleanEx()
nameEx("add_variable_group_header")
### * add_variable_group_header

flush(stderr()); flush(stdout())

### Name: add_variable_group_header
### Title: Variable Group Header
### Aliases: add_variable_group_header
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed(c("cardx", "car"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
...
## Don't show: 
if (gtsummary:::is_pkg_installed("flextable")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
trial |>
...
### Name: as_gtsummary
### Title: Create gtsummary table
### Aliases: as_gtsummary
...
## Don't show: 
if (gtsummary:::is_pkg_installed("huxtable")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
trial |>
  tbl_summary(by = trt, include = c(age, grade)) |>
  add_p() |>
...
## Don't show: 
if (gtsummary:::is_pkg_installed("kableExtra")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed(c("effectsize", "mice", "parameters"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
...
cleanEx()
nameEx("deprecated_modify_footnote")
### * deprecated_modify_footnote

flush(stderr()); flush(stdout())

### Name: deprecated_modify_footnote
### Title: DEPRECATED Footnote
### Aliases: deprecated_modify_footnote modify_footnote
### Keywords: internal
...
## Don't show: 
if (gtsummary:::is_pkg_installed('cardx')) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
###   global_pvalue_fun.geeglm
### Keywords: internal

### ** Examples

## Don't show: 
if (gtsummary:::is_pkg_installed(c("cardx", "broom", "car"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (gtsummary:::is_pkg_installed(c("cardx", "broom", "broom.helpers"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
inline_text_ex1 <-
...
## Don't show: 
if (gtsummary:::is_pkg_installed("survival")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
library(survival)
...
### Aliases: modify modify_header modify_spanning_header
###   remove_spanning_header show_header_names
...
cleanEx()
nameEx("modify_abbreviation")
### * modify_abbreviation

flush(stderr()); flush(stdout())

### Name: modify_abbreviation
### Title: Modify Abbreviations
### Aliases: modify_abbreviation remove_abbreviation
...
cleanEx()
nameEx("modify_bold_italic")
### * modify_bold_italic

flush(stderr()); flush(stdout())

### Name: modify_bold_italic
### Title: Modify Bold and Italic
### Aliases: modify_bold_italic modify_bold remove_bold modify_italic
###   remove_italic
...
### Aliases: modify_column_merge remove_column_merge

### ** Examples

## Don't show: 
if (gtsummary:::is_pkg_installed("cardx") && gtsummary:::is_pkg_installed("broom", ref = "cardx")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
trial |>
...
cleanEx()
nameEx("modify_footnote2")
### * modify_footnote2

flush(stderr()); flush(stdout())

### Name: modify_footnote2
### Title: Modify Footnotes
### Aliases: modify_footnote2 modify_footnote_header modify_footnote_body
###   modify_footnote_spanning_header remove_footnote_header
###   remove_footnote_body remove_footnote_spanning_header
...
cleanEx()
nameEx("modify_missing_symbol")
### * modify_missing_symbol

flush(stderr()); flush(stdout())

### Name: modify_missing_symbol
### Title: Modify Missing Substitution
### Aliases: modify_missing_symbol
...
cleanEx()
nameEx("modify_source_note")
### * modify_source_note

flush(stderr()); flush(stdout())

### Name: modify_source_note
### Title: Modify source note
### Aliases: modify_source_note remove_source_note
...
cleanEx()
nameEx("tbl_hierarchical")
### * tbl_hierarchical

flush(stderr()); flush(stdout())

### Name: tbl_hierarchical
### Title: Hierarchical Table
### Aliases: tbl_hierarchical tbl_hierarchical_count
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed("cardx") && gtsummary:::is_pkg_installed("survival", ref = "cardx")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
...
## Don't show: 
if ((identical(Sys.getenv("NOT_CRAN"), "true") || identical(Sys.getenv("IN_PKGDOWN"), "true")) && gtsummary:::is_pkg_installed(c("cardx", "broom"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
trial |>
...
cleanEx()
nameEx("tbl_strata_nested_stack")
...
## Don't show: 
if (gtsummary:::is_pkg_installed(c("cardx", "survey"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
# Example 1 ----------------------------------
survey::svydesign(~1, data = as.data.frame(Titanic), weights = ~Freq) |>
  tbl_svysummary(by = Survived, percent = "row", include = c(Class, Age))
