...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("aod", "broom.helpers")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = "survey"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("broom.helpers", "car", "parameters")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
lm(AGE ~ ARM, data = cards::ADSL) |>
  ard_car_anova()
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = "car"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (cardx:::is_pkg_installed("survey")) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = "broom"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("effectsize", "parameters")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
cards::ADSL |>
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = "emmeans"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
ard_emmeans_mean_difference(
  data = mtcars,
  formula = mpg ~ am + cyl,
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = "broom.helpers"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
lm(AGE ~ ARM, data = cards::ADSL) |>
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = "smd"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("broom", "withr", "lme4")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
anova(
  lm(mpg ~ am, mtcars),
  lm(mpg ~ am + hp, mtcars)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("broom.helpers", "parameters")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("survey", "broom")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
data(api, package = "survey")
dclus1 <- survey::svydesign(id = ~dnum, weights = ~pw, data = apiclus1, fpc = ~fpc)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("survival", "broom", "ggsurvfit")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
library(survival)
library(ggsurvfit)
...
### Aliases: ard_survival_survfit ard_survival_survfit.survfit
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("survival", "ggsurvfit")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
library(ggsurvfit)
library(survival)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("withr", "lme4", "broom.helpers", "broom.mixed")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
construct_model(
  data = mtcars,
  formula = am ~ mpg + (1 | vs),
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = c("survival", "broom")))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
...
## Don't show: 
if (do.call(asNamespace("cardx")$is_pkg_installed, list(pkg = "survival"))) (if (getRversion() >= "3.4") withAutoprint else force)({ # examplesIf
## End(Don't show)
