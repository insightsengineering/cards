...
Returning the arguments improves the tracability of the ARD, and requires combining the function's default arguments (the formals) and any argument passed by the user.
...
my_ard_one_sample_t_test <- function(data, variable, ...) {
  ...
  t_test_fun <- 
    cards::as_cards_fn(
      t_test_fun, 
      c("estimate", "statistic", "p.value", "parameter", 
